namespace Application.Commands.Org.Transactions.Inventory.Queries
{
    ...
    public sealed class SearchQueryHandler(IRepository<Domain.Entities.Inventory> _Repository,
        IRepository<Domain.Entities.Transaction> transactionRepository, IMapper mapper) : SearchCommandHandler<SearchInventoryQuery, Domain.Entities.Inventory, InventoryDto>(_Repository, mapper)
    {
