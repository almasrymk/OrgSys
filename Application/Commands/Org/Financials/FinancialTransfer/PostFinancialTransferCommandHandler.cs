...
public sealed class GetFinancialTransfersQueryHandler(
    IRepository<Domain.Entities.FinancialTransfer> repository,
    IRepository<Journal> journalRepository) : IRequestHandler<GetFinancialTransfersQuery, ResultCollection<FinancialTransferDto>>
{
    ...
    internal static FinancialTransferDto Map(Domain.Entities.FinancialTransfer row, long? journalId) => new()
    {
    ...
    Application.Common.Services.IAccountingPeriodService accountingPeriodService) : ICommandHandler<PostFinancialTransferCommand>
{
    public async Task<Result> Handle(PostFinancialTransferCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var transfer = new Domain.Entities.FinancialTransfer
            {
