namespace Application.Commands.Org.Setting.FinancialAccount.Commands
{
    ...
    public sealed class CreateCommandHandler(
        IUnitOfWork _UnitOfWork, IRepository<Domain.Entities.FinancialAccount> _Repository, IMapper mapper,
        IReceivableAccountValidator accountValidator)
        : CreateCommandHandler<CreateFinancialAccountCommand, Domain.Entities.FinancialAccount>(_UnitOfWork, _Repository, mapper)
    {
