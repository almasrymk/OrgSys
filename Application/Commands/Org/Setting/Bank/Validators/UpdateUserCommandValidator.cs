namespace Application.Commands.Org.Setting.Bank.Validators
{
    ...
    public class UpdateBankCommandValidator : Validator<UpdateBankCommand, Domain.Entities.Bank>
    {
        public UpdateBankCommandValidator(IRepository<Domain.Entities.Bank> _Repository) : base(_Repository)
        {
            RuleFor(c => c.Name)
