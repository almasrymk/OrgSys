...
namespace Application.Commands.Org.Setting.ProductUnit.Queries
{
    ...
    public sealed class GetListQueryHandler(IRepository<Domain.Entities.ProductUnit> _Repository, IMapper mapper) : ListCommandHandler<GetListProductUnitQuery, Domain.Entities.ProductUnit, ProductUnitDto>(_Repository, mapper)
    {       
