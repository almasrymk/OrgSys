namespace Application.Commands.Org.Setting.Branch.Commands
{
    ...
    public sealed class DeleteListCommandHandler(IUnitOfWork _UnitOfWork, IRepository<Entity.Model.Branch> _Repository , IMapper mapper) : DeleteCommandHandler<DeleteListBranchCommand, Entity.Model.Branch>(_UnitOfWork, _Repository , mapper)
    {
