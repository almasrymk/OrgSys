namespace Application.Commands.Org.Setting.Product.Commands
{
    ...
    public sealed class DeleteCommandHandler(IUnitOfWork _UnitOfWork, IRepository<Entity.Model.Product> _Repository , IMapper mapper) : DeleteCommandHandler<DeleteProductCommand, Entity.Model.Product>(_UnitOfWork, _Repository , mapper)
    {
