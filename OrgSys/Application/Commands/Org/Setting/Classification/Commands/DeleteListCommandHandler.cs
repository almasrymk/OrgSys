namespace Application.Commands.Org.Setting.Classification.Commands
{
    ...
    public sealed class DeleteListCommandHandler(IUnitOfWork _UnitOfWork, IRepository<Entity.Model.Classification> _Repository, IServiceProvider _provider) : DeleteCommandHandler<DeleteListClassificationCommand, Entity.Model.Classification>(_UnitOfWork, _Repository , _provider)
    {
