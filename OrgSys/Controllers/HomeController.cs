...
namespace OrgSys.Controllers
{
    ...
    public class HomeController : HomeBaseController
    {
        ...
        public IActionResult Register(string Key)
        {
            ...
            //items.Add(new SelectListItem { Value = "1", Text = OrgSys.Localization.Title_Designer.From + " 1 " + OrgSys.Localization.Title_Designer.To + " 5 " + OrgSys.Localization.Title_Designer.Employees });
            //items.Add(new SelectListItem { Value = "2", Text = OrgSys.Localization.Title_Designer.From + " 5 " + OrgSys.Localization.Title_Designer.To + " 50 " + OrgSys.Localization.Title_Designer.Employees });
            //items.Add(new SelectListItem { Value = "3", Text = OrgSys.Localization.Title_Designer.From + " 50 " + OrgSys.Localization.Title_Designer.To + " 150 " + OrgSys.Localization.Title_Designer.Employees });
            //items.Add(new SelectListItem { Value = "4", Text = OrgSys.Localization.Title_Designer.From + " 150 " + OrgSys.Localization.Title_Designer.To + " 1500 " + OrgSys.Localization.Title_Designer.Employees });
            //items.Add(new SelectListItem { Value = "5", Text = OrgSys.Localization.Title_Designer.MoreThen + " 1500 " + OrgSys.Localization.Title_Designer.Employees });
