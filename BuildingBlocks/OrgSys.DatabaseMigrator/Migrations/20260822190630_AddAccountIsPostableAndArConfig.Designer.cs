...
namespace OrgSys.DatabaseMigrator.Migrations
{
    ...
    [Migration("20260822190630_AddAccountIsPostableAndArConfig")]
    partial class AddAccountIsPostableAndArConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.AccountBank", b =>
                {
                    ...
                    b.HasOne("Treasury.Domain.FinancialAccount", "FinancialAccount")
                        .WithOne("BankAccount")
                        .HasForeignKey("Domain.Entities.AccountBank", "FinancialAccountId")
