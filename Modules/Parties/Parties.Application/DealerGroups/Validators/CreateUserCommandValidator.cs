namespace Parties.Application.DealerGroups.Validators
{
    ...
    public class CreateDealerGroupCommandValidator : Validator<CreateDealerGroupCommand,  Parties.Domain.DealerGroup>
    {
        public CreateDealerGroupCommandValidator(IRepository<Parties.Domain.DealerGroup> _Repository) : base(_Repository)
        {
            RuleFor(c => c.Code)
