namespace Sales.Application.Dealers.Validators
{
    ...
    public class CreateDealerCommandValidator : Validator<CreateDealerCommand,  Sales.Domain.Dealer>
    {
        public CreateDealerCommandValidator(IRepository<Sales.Domain.Dealer> _Repository) : base(_Repository)
        {
