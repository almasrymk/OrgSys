namespace Sales.Application.Dealers.Validators
{
    using FluentValidation;
    using OrgSys.SharedKernel;
    using Sales.Application.Dealers.Commands;

    public class UpdateDealerCommandValidator : Validator<UpdateDealerCommand, Sales.Domain.Dealer>
    {
        public UpdateDealerCommandValidator(IRepository<Sales.Domain.Dealer> _Repository) : base(_Repository)
        {
