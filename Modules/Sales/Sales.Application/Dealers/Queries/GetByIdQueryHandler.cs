namespace Sales.Application.Dealers.Queries
{
    ...
    public sealed class GetByIdQueryHandler(IRepository<Sales.Domain.Dealer> _Repository, IMapper mapper) : GetCommandHandler<GetByIdDealerQuery, Sales.Domain.Dealer, DealerDto>(_Repository, mapper)
    {
        public override Expression<Func<Sales.Domain.Dealer, bool>> CreateFilter(GetByIdDealerQuery request)
        {
