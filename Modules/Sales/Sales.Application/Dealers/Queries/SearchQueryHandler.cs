namespace Sales.Application.Dealers.Queries
{
    ...
    public sealed class SearchQueryHandler(IRepository<Sales.Domain.Dealer> _Repository, IMapper mapper) : SearchCommandHandler<SearchDealerQuery, Sales.Domain.Dealer, DealerDto>(_Repository, mapper)
    {
        public override Expression<Func<Sales.Domain.Dealer, bool>> CreateFilter(SearchDealerQuery request)
        {
            Page = request.Page;
        ...
        override public Func<IQueryable<Sales.Domain.Dealer>, IOrderedQueryable<Sales.Domain.Dealer>> CreateOrderBy(SearchDealerQuery request)
        {
