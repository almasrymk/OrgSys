...
namespace Sales.Application.Invoices.Queries
{
    ...
    public sealed class GetInvoiceNotReturnedQueryHandler(IRepository<Sales.Domain.Invoice> _Repository, IMapper mapper) : SearchCommandHandler<GetInvoiceNotReturnedQuery, Sales.Domain.Invoice, InvoiceDto>(_Repository, mapper)
    {
        ...
        override public Func<IQueryable<Sales.Domain.Invoice>, IOrderedQueryable<Sales.Domain.Invoice>> CreateOrderBy(GetInvoiceNotReturnedQuery request)
        {
