...
namespace Sales.Application.Invoices.Queries
{
    ...
    public sealed class GetProductsNotReturnedQueryHandler(IRepository<Sales.Domain.Invoice> _Repository, IMapper mapper) : ListCommandHandler<GetProductsNotReturnedQuery, Sales.Domain.Invoice, InvoiceProductDto>(_Repository, mapper)
    {
