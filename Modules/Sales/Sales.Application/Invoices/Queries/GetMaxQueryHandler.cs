namespace Sales.Application.Invoices.Queries
{
    ...
    public sealed class GetMaxQueryHandler(IRepository<Sales.Domain.Invoice> _Repository) : GetMaxCommandHandler<GetMaxInvoiceQuery, Sales.Domain.Invoice>(_Repository)
    {
