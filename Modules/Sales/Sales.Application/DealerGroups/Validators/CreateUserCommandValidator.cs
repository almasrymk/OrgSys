namespace Sales.Application.DealerGroups.Validators
{
    ...
    public class CreateDealerGroupCommandValidator : Validator<CreateDealerGroupCommand,  Sales.Domain.DealerGroup>
    {
        public CreateDealerGroupCommandValidator(IRepository<Sales.Domain.DealerGroup> _Repository) : base(_Repository)
        {
            RuleFor(c => c.Code)
