namespace MasterData.Application.Units.Validators
{
    ...
    public class UpdateUnitCommandValidator : Validator<UpdateUnitCommand, MasterData.Domain.Unit>
    {
        public UpdateUnitCommandValidator(IRepository<MasterData.Domain.Unit> _Repository) : base(_Repository)
        {
            RuleFor(c => c.Name)
