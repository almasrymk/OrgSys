namespace MasterData.Application.Cities.Validators
{
    ...
    public class CreateUserCommandValidator : Validator<CreateCityCommand ,  MasterData.Domain.City>
    {
        public CreateUserCommandValidator(IRepository<MasterData.Domain.City> _Repository , IRepository<MasterData.Domain.Country> _CountryRepository) : base(_Repository)
        {
            RuleFor(c => c.Name)
