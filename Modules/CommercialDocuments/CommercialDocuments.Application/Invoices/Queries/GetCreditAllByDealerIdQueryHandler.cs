...
namespace CommercialDocuments.Application.Invoices.Queries
{
    ...
    public sealed class GetCreditAllByDealerIdQueryHandler(IRepository<CommercialDocuments.Domain.Invoice> _Repository, IMapper mapper) :
        SearchCommandHandler<GetCreditAllByDealerIdQuery, CommercialDocuments.Domain.Invoice, InvoiceDto>(_Repository, mapper)
    {
        ...
        public override Func<IQueryable<CommercialDocuments.Domain.Invoice>, IOrderedQueryable<CommercialDocuments.Domain.Invoice>> CreateOrderBy(GetCreditAllByDealerIdQuery request)
        {
            return e => e.OrderByDescending(e => e.Id);
        }

        public override Expression<Func<CommercialDocuments.Domain.Invoice, bool>> CreateFilter(GetCreditAllByDealerIdQuery request)
        {
