namespace Inventory.Application.Products.Commands
{
    ...
    public sealed class DeleteListCommandHandler(IUnitOfWork _UnitOfWork, IRepository<Inventory.Domain.Product> _Repository, IServiceProvider _provider) : DeleteCommandHandler<DeleteListProductCommand, Inventory.Domain.Product>(_UnitOfWork, _Repository, _provider)
    {
        public override Expression<Func<Inventory.Domain.Product, bool>> CreateFilter(DeleteListProductCommand request)
        {
