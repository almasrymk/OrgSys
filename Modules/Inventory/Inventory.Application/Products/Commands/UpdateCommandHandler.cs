namespace Inventory.Application.Products.Commands
{
    ...
    public sealed class UpdateCommandHandler(IUnitOfWork _UnitOfWork, IRepository<Inventory.Domain.Product> _Repository, IRepository<Inventory.Domain.ProductUnit> _ProductUnitRepository, IMapper mapper, IServiceProvider _provider) : UpdateCommandHandler<UpdateProductCommand, Inventory.Domain.Product>(_UnitOfWork, _Repository, mapper , _provider)
    {
