namespace Inventory.Application.Inventories.Commands
{
    ...
    public sealed class UpdateInventoryCommand : InventoryDto, ICommand, IUpdateCommand<Result>;
    public sealed class UpdateCommandHandler(IUnitOfWork _UnitOfWork,
        ...
        IMapper mapper, IServiceProvider _provider) : UpdateCommandHandler<UpdateInventoryCommand, Inventory.Domain.Inventory>(_UnitOfWork, _Repository , mapper , _provider)
    {
