namespace Administration.Application.Users.Validators
{
    ...
    public class UpdateUserCommandValidator : Validator<UpdateUserCommand, Administration.Domain.User>
    {
        public UpdateUserCommandValidator(IRepository<Administration.Domain.User> _Repository) : base(_Repository)
        {
            RuleFor(c => c.Name)
