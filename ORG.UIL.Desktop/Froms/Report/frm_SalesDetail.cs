...
{
    public partial class frm_SalesDetail : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var salesDetail = new ReportRepo().salesDetailsReport(dateTimePicker1.Value, dateTimePicker2.Value,int.Parse("0" + cmbUser.SelectedValue));
                ...
                foreach (var item in salesDetail)
                {
                    ...
                    dgvTransactions["colNet", Row].Value = item.Net;
        ...
        {
            bottunOrg1.Enabled = false;
            var salesDetail = new ReportRepo().salesDetailsReport(dateTimePicker1.Value, dateTimePicker2.Value, int.Parse("0" + cmbUser.SelectedValue), ++currPage);
            lblPagging.Visible = salesDetail.Count == 100;
            foreach (var item in salesDetail)
            {
                Application.DoEvents();
        ...
        private void dgvTransactions_DoubleClick(object sender, EventArgs e)
        {
            ...
            ((frm_Main)Application.OpenForms["frm_Main"]).SelectMenu("invoice", true , id);          
        }
    }
}