...
public class SupplierPaymentPostedIntegrationEventHandlerTests
{
        ...
        IReadOnlyList<Payable> openPayables, bool alreadyApplied = false)
    {
        ...
        var handler = new SupplierPaymentPostedIntegrationEventHandler(payableRepository.Object, paymentApplicationRepository.Object, unitOfWork.Object, InboxTestDoubles.AlwaysClaim());
