...
namespace Service
{
    public class TableService : BaseOrgService<TableDto, Table>
    {
        ...
        public List<TableDto> GetAllClosed(long id, long parentId = 0, long TypeId = 0)
        {
            ...
            return repo.GetList(e => !ids.Contains(e.Id), e => e.OrderBy(e => e.Id), Includes, Utility.Status.New).Select(e => e.Map<TableDto>()).ToList();
        }
    }
}