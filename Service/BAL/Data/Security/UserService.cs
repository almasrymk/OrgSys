...
namespace Service
{
    public class UserService : BaseService<UserModelView>
    {
        ...
        public bool CheckEmail(string Email) => repo.userRepo.Any(e => e.UserName.ToLower() == Email.ToLower());

        public bool HavePassword(string Email) => "" + repo.userRepo.Get(e => e.UserName.ToLower() == Email.ToLower()).Password != "";

        public bool CheckEmailAndPassword(string Email,string Passord) => repo.userRepo.Any(e => e.UserName.ToLower() == Email.ToLower() &&e.Password==Passord);
