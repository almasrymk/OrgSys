...
namespace Service.BAL
{
    public class ReturnInvoiceService : BaseService<InvoiceModelView>
    {
        ...
        {
            return repo.invoiceRepo.GetList(e=> e.TypeId == TypeId, e => e.OrderBy(e => e.Id), "Dealer", Utility.Status.New).Select(e => new InvoiceModelView(e)).ToList();
        }
        ...
        {
            return repo.invoiceRepo.GetList(e => e.TypeId == TypeId && e.Dealer.Name.Contains("" + textSearch), e => e.OrderBy(e => e.Id), "Dealer", Utility.Status.New).Select(e => new InvoiceModelView(e)).ToList();
        }
        ...
        {
            return repo.invoiceRepo.GetList(e=> e.TypeId == TypeId , e => e.OrderBy(e => e.Id), "Dealer", Utility.Status.New).Select(e => new InvoiceModelView(e)).ToPagedList(page, pageSize);
        }
        ...
        {
            return repo.invoiceRepo.GetList(e => e.TypeId == TypeId && ("" + textSearch == "" || e.Dealer.Name.Contains("" + textSearch)), e => e.OrderBy(e => e.Id), "Dealer", Utility.Status.New).Select(e => new InvoiceModelView(e)).ToPagedList(page, pageSize);
        }
